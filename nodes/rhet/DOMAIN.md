...
- [STYLE-GUIDE.md](../STYLE-GUIDE.md) — delivery calibration and framing techniques
- [CLOSE-CONDITIONS.md](../CLOSE-CONDITIONS.md) — argument endpoint procedures

This domain's node files cover specific rhetorical phenomena as TOPICS — when the argument IS about a rhetorical tactic, terminological confusion, or discourse pattern.
...
6. "Be realistic" / "be pragmatic" / "be practical" — these are frequently deployed to prevent structural analysis, not to improve it. Realism about an unjust system is not a virtue.
...
| False Equivalence | [false-equivalence.md](false-equivalence.md) | "Both sides" gambit, false neutrality, asymmetry erasure, centrism as identity |
